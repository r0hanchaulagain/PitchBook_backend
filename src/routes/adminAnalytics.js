...
router.get('/low-performing-futsals', isAdmin, adminAnalytics.getLowPerformingFutsals);
router.get('/futsals-by-location', isAdmin, adminAnalytics.getFutsalsByLocation);
router.get('/bookings-by-location', isAdmin, adminAnalytics.getBookingsByLocation);
router.get('/active-vs-inactive-futsals', isAdmin, adminAnalytics.getActiveVsInactiveFutsals);
